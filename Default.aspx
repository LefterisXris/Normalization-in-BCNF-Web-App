...
<body>
    ...
    <div class="container">
        ...
        <div class ="page-header">  <%--TODO: Στην δημιουργία σχήματος να περνάς το όνομα εδώ στο label --%>
            <h1> Νέο σχήμα: <asp:Label ID="lblSchemaName" runat="server" Text="Default"></asp:Label> <small> γνωρίσματα και συναρτησιακές εξαρτήσεις. </small> </h1>
        </div>
        ...
        <div class="row"> 
            ...
            <div class="col-md-3">
             <!--   <button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalKeys">Υποψήφια κλειδιά</button> -->
                ...
                <!-- Modal Υποψήφια κλειδιά-->  <%--TODO: Διαγραφή?? --%>
            ...
            <div class="col-md-3">
             <!--  <button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalDecompose">Διάσπαση BCNF</button> -->
                ...
                <!-- Modal Διάσπαση BCNF-->  <%--TODO: Διαγραφή?? --%>
