...
<body>
    ...
    <div class="container">
        ...
        <div class ="page-header">  <%--TODO: Στην δημιουργία σχήματος να περνάς το όνομα εδώ στο label --%>
            <h1> Σταδιακή διάσπαση: <asp:Label ID="lblSchemaName" runat="server" Text="Default"></asp:Label> <small> γνωρίσματα και συναρτησιακές εξαρτήσεις. </small> </h1>
        </div>
        ...
        <div class="row"> 
            ...
            <div class="col-md-6 col-sm-6"> 
                <div>
                    ...
                    <p> <b>Πίνακες</b></p>
                    <asp:CheckBoxList ID="TablesCheckBoxList" runat="server"></asp:CheckBoxList>
                ...
                <div style="margin-top:35px;">
                    ...
                    <asp:CheckBoxList ID="FDsCheckBoxList" runat="server"></asp:CheckBoxList>
